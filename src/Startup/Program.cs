...
using Rsp.ManageNotificationsFunction.Application.Settings;
using Rsp.ManageNotificationsFunction.Infrastructure.HttpMessageHandlers;
using Rsp.ManageNotificationsFunction.Startup.Configuration;

namespace Rsp.ManageNotificationsFunction.Startup;
...
public static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddSingleton<TokenCredential>(_ =>
        {
            ...
            return new ManagedIdentityCredential(appSettings.ManagedIdentityManageNotificationsClientID);
        });
